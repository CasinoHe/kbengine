...
Entity::~Entity()
{
	...
	if(Baseapp::getSingletonPtr()->pEntities())
		Baseapp::getSingletonPtr()->pEntities()->pGetbages()->erase(id());
...
PyObject* Entity::createCellEntity(PyObject* pyobj)
{
	...
	if(Baseapp::getSingletonPtr()->findEntity(id()) == NULL)
	{
	...
	creatingCell_ = true;
	Baseapp::getSingletonPtr()->createCellEntity(cellEntityCall, this);
	S_Return;
}
...
void Entity::restoreCell(EntityCallAbstract* cellEntityCall)
{
	...
	if(createdSpace_)
	{
		Baseapp::getSingletonPtr()->restoreSpaceInCell(this);
	}
	else
	{
		Baseapp::getSingletonPtr()->createCellEntity(cellEntityCall, this);
...
PyObject* Entity::createCellEntityInNewSpace(PyObject* args)
{
	...
	createdSpace_ = true;
	Baseapp::getSingletonPtr()->createCellEntityInNewSpace(this, args);
	S_Return;
}
